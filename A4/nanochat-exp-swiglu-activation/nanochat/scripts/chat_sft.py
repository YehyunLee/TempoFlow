...
from tasks.autoif import AutoIF
...
train_tasks = [
    ...
    *[GSM8K(subset="main", split="train") for _ in range(args.gsm8k_epochs)], # 8K rows per epoch
    ...
    AutoIF(split="train"), # 61.5K rows of AutoIF (conversations with Python eval functions as constraints)
    OpenCoder(split="train"), # 118K rows of OpenCoder (educational coding instruction-response pairs)
]
