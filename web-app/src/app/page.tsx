...
export default function Home() {
  ...
  // Ensures server and client render 'null' first, 
  // then client renders the actual UI.
  useEffect(() => {
    setMounted(true);
  }, []);
          ...
          {status === "authenticated" ? (
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className="px-5 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-full hover:bg-red-50 hover:text-red-600 transition-all active:scale-95 shadow-sm"
              >
                Log Out
              </button>
            </div>
